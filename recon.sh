...
installations() {
	...
	go get -u -v github.com/caffix/amass
...
Passive_Subdomain_Enumerations () {
	...
	/home/ubuntu/go/bin/assetfinder -subs-only $1 >> "/tmp/assetfinder_$1.txt"
	/home/ubuntu/go/bin/crobat -s $1 >> "/tmp/crobat_$1.txt"
	/home/ubuntu/go/bin/subfinder -d $1  -silent -o "/tmp/subfinder_$1.txt"
...
resolve_subs() {
	...
	echo "$1"
	/home/ubuntu/go/bin/shuffledns -d $1 -list "/home/ubuntu/Recon/$1/$1_passive.txt" -r "/home/ubuntu/Recon/$1/resolvers.txt" -silent -o "/home/ubuntu/Recon/$1/$1_subdomains.txt"
	rm "/home/ubuntu/$1_passive.txt"
...
takeover_checks() {
	...
	/home/ubuntu/go/bin/takeover -l /home/ubuntu/Recon/$1/$1_subdomains.txt -p /home/ubuntu/go/src/github.com/mzfr/takeover/providers.json -t 80 >> "/home/ubuntu/Recon/$1/$1_sustakeover.txt"
...
httprobes() {
	...
	cat "/home/ubuntu/Recon/$1/$1_subdomains.txt" | /home/ubuntu/go/bin/httprobe -c 80 -p 80,443,8443,8043,8080,8081,8089 >> "/home/ubuntu/Recon/$1/$1_httprobe.txt"
...
nuclei_checks() {
	...
	for i in $(cat "/home/ubuntu/tests.txt"); do /home/ubuntu/go/bin/nuclei -l "/home/ubuntu/Recon/$1/$1_subdomains.txt" -t /home/ubuntu/nuclei-templates/$i -silent >> "/home/ubuntu/Recon/$1/$1_nuclei.txt"; done
...
screenshots() {
	...
	cat "/home/ubuntu/Recon/$1/$1_httprobe.txt" | /home/ubuntu/go/bin/go-stare -o "/home/ubuntu/Recon/$1/$1_screenshots"
